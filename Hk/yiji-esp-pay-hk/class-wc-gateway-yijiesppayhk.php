...
function yjpayesp_gateway_init (){
    ...
    class WC_YiJiEspPayByHk extends WC_Payment_Gateway{
        ...
        public function __construct(){
            ...
            //array_push($this->supports,'hold');
            //add_action('woocommerce_update_options_payment_gateways_yijiesppay_hk', array($this, 'process_admin_options'));
            ...
            //add_action( 'woocommerce_order_again_button', array( $this, 'testb' ) );
            // Customer Emails
